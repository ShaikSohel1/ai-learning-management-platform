...
class RecommendedCourse(BaseModel):
    ...
    difficulty: Optional[str] = Field(default="Beginner", description="Course difficulty level")
...
class AIChatRequest(BaseModel):
    ...
    career_goal: Optional[str] = Field(default=None, description="Optional current user career goal for context")
    current_skills: Optional[List[str]] = Field(default=None, description="Optional user skills for context")
