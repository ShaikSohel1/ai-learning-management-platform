...
class AgentStepResult(BaseModel):
    ...
    structured_data: Optional[Dict[str, Any]] = Field(default_factory=dict, description="Structured data returned by agent")
...
class AgentChatRequest(BaseModel):
    ...
    career_goal: Optional[str] = Field(None, description="Optional career goal context")
    current_skills: Optional[List[str]] = Field(default_factory=list, description="Optional user skills context")
